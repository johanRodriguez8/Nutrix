"""All SQL touching the ``history`` table."""
from db.connection import db


class HistoryRepository:
    def distinct_part_ids(self):
        return db.query("SELECT DISTINCT part_id FROM history ORDER BY part_id")
    ...
    def delete(self, part_id):
        db.execute("DELETE FROM history WHERE part_id=?", (part_id,))
